...
namespace FederataFutbollit.Migrations
{
    ...
    [Migration("20240625144530_AddSuperligaToReferi")]
    partial class AddSuperligaToReferi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FederataFutbollit.Entities.CartSeat", b =>
                {
                    ...
                    b.Property<string>("SeatFirstName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SeatLastName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FederataFutbollit.Entities.Rezultati", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DataNdeshjes")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("GolatEkipi1")
                        .HasColumnType("int");

                    b.Property<int>("GolatEkipi2")
                        .HasColumnType("int");

                    b.Property<string>("Kundershtari")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("NdeshjaSuperligesId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("NdeshjaSuperligesId");
            ...
            modelBuilder.Entity("FederataFutbollit.Models.Referi", b =>
                {
                    b.Property<int>("Referi_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Referi_ID"));
            ...
            modelBuilder.Entity("FederataFutbollit.Entities.Rezultati", b =>
                {
                    b.HasOne("FederataFutbollit.Entities.NdeshjaSuperliges", "NdeshjaSuperliges")
                        .WithMany()
                        .HasForeignKey("NdeshjaSuperligesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NdeshjaSuperliges");
                });
            ...
            modelBuilder.Entity("FederataFutbollit.Models.Referi", b =>
                {
                    ...
                    b.HasOne("FederataFutbollit.Entities.Superliga", null)
                        .WithMany("Referis")
                        .HasForeignKey("SuperligaId1");
